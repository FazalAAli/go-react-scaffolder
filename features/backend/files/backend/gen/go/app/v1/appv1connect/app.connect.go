...
const (
	...
	GreeterServiceName = "app.v1.GreeterService"
)
...
const (
	...
	GreeterServiceGreetProcedure = "/app.v1.GreeterService/Greet"
)

// GreeterServiceClient is a client for the app.v1.GreeterService service.
type GreeterServiceClient interface {
	Greet(context.Context, *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error)
}

// NewGreeterServiceClient constructs a client for the app.v1.GreeterService service. By default, it
...
func NewGreeterServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreeterServiceClient {
	...
	greeterServiceMethods := v1.File_app_v1_app_proto.Services().ByName("GreeterService").Methods()
...
// Greet calls app.v1.GreeterService.Greet.
...
// GreeterServiceHandler is an implementation of the app.v1.GreeterService service.
...
func NewGreeterServiceHandler(svc GreeterServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/app.v1.GreeterService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGreeterServiceHandler) Greet(context.Context, *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("app.v1.GreeterService.Greet is not implemented"))
}
